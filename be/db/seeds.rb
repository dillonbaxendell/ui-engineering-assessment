...
user_1 = User.create({ first_name: 'Event', last_name: 'Creator', email_address: 'test@threeflow.com' })
...
event_1 = Event.create({ user_id: 1, name: 'Meetup at Threeflow', location: 'Threeflow', start_date: '2024-01-01T00:00:00.000Z' })
...
event_4 = Event.create({ user_id: 1, name: 'Celebration', location: 'Threeflow', start_date: '2024-01-01T00:00:00.000Z' })
